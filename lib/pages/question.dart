            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  var question = context.read<QuestionsCN>().results[index - 1];
...
class _RowQuestionSearchResultState extends State<RowQuestionSearchResult> {
              ...
              children: [
                Flexible(
                  child: Padding(
                    padding: const EdgeInsets.only(
                        left: 16, right: 0, top: 16, bottom: 16),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(
                ...
                Container(
                    decoration: BoxDecoration(
                        border: Border(
                            left: BorderSide(
                                color: MColors.grey.shade200, width: 1))),
                    width: 160.0,
                    child: Column(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Icon(FeatherIcons.chevronRight,
                                        size: 16, color: MColors.grey.shade500),
                                  ],
                                )),
                          ),
                          Expanded(
                            child: widget.question.sourceMsName.isNotEmpty
                                ? Container(
                                    ...
                                    child: RawMaterialButton(
                                        ...
                                        child: Row(
                                          children: [
                                            Text(widget.question.sourceMsName,
                                                style: MTextStyles.smMdGrey900),
                                            const Spacer(),
                                            Icon(FeatherIcons.chevronRight,
                                                size: 16,
                            ...
                            child: widget.question.answerContent.isNotEmpty
                                ...
                                : Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        color: MColors.grey.shade100),
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text('Answer not available',
                                        style: MTextStyles.smMdGrey500),
                                  ),
                          ),
                        ]))
  ...
  void showPdfPreview(
      BuildContext context, String viewingPdfName, String viewingPdfUrl) {
